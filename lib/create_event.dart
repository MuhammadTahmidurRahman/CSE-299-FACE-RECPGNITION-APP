...
class _CreateEventPageState extends State<CreateEventPage> {
  ...
  Future<void> _createRoomInFirebase(String roomName) async {
    ...
    // Generate a sanitized composite key for the host
    final sanitizedEmail = email.replaceAll('.', '_');
    final hostCompositeKey = '${_eventCode}_${roomName}_${sanitizedEmail}_${name}';
    ...
    // Save the host's information under rooms/$eventCode/host/$hostCompositeKey
    ...
    // Listen for updates to the user's profile and update host data only
